...
public class UserPosDAO {
	...
	public Userposjava buscar(Long id) throws Exception {
		...
		while (resultado.next()) { // retorna apernas 1 ou nenhum
	...
	public void atualizar(Userposjava userposjava) { // Realiza o uodate no banco
	...
	public void deletarTudo() {
		...
		try {
			...
			String sql = "delete from userposjava";
			PreparedStatement preparedStatement = connection.prepareStatement(sql);
			preparedStatement.execute();
			connection.commit();
		} catch (Exception e) {
	...
	public List<BeanUserFone> listarUserFone(Long idUser) {
		...
		String sql = "select nome, numero, email from telefoneuser as f";
		sql += " inner join userposjava as u";
		sql += " on f.usuariopessoa = u.id";
	...
	public void deleteFoneForUser(Long id) {
